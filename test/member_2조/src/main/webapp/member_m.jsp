        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    ...
                    <div class="col-sm-2">
					   <form method="post" action="./member_m.jsp" >
	                        <select class="custom-select col-sm-7" name = 'limitCnt'>
	                        ...
	                        <input type = "hidden" name = "currentPageNo"  value =0>
				      		<input type ="submit" class="btn btn-light" style="color:black;" value = "확인">
	                   </form>
                    </div>
                </div>
            </div>
				...
				<tr>
					...
					<th><%=mem_class%></th>
					<th>
					<a href="./member_m2.jsp?mem_num=<%=mem_num %>&mem_name=<%=mem_name %>&mem_id=<%=mem_id %>&mem_passwd=<%=mem_passwd %>&mem_phone=<%=mem_phone %>&mem_email=<%=mem_email %>&mem_RRN=<%=mem_RRN %>&mem_class=<%=mem_class %>"
					class="edit"> 
            ...
            <div class="clearfix">
                <ul class="pagination">
                   <li class="page-item disabled"><a href="./member_m.jsp?currentPageNo=0&limitCnt=<%=limitCnt%>">처음으로</a></li>
				<%      
				   
				   if(currentPageNo > 0 ){
				%>
				  <li class="page-item"><a href="./member_m.jsp?currentPageNo=<%=(currentPageNo-1) %>&limitCnt=<%=limitCnt%>" class="page-link">이전 </a></li>
				<%
				   }
				   else{
				...
				%>
				 ...
				 %>
				     ...
				     <li class="page-item" ><a href="./member_m.jsp?currentPageNo=<%=i %>&limitCnt=<%=limitCnt%>" class="page-link"><%=i+1 %></a></li>  
				...
				<%
				 ...
				 %>
				  <li class="page-item"><a href="./member_m.jsp?currentPageNo=<%=(currentPageNo+1) %>&limitCnt=<%=limitCnt%>" class="page-link">다음</a></li>
				 <%
				   }else{
				 %>
				 ...
				 <%
				   ...
				   con.close();
				 %>
				 <li class="page-item"><a href="./member_m.jsp?currentPageNo=<%=(pageCnt-1) %>&limitCnt=<%=limitCnt%>" class="page-link">마지막</a></li>    
                </ul>
                
            </div>
			<button type="button" class="btn btn-black" style="color: grey;" onclick="location.href='./index.jsp'"><small>메인메뉴</small></button>
        </div>
    </div>
</div>
