...
<head>
    ...
    function checkRRN() {
        ...
        let count = 2;
        let lastRRN = 0;
        mem_RRN = document.getElementById("mem_RRN1").value + document.getElementById("mem_RRN2").value;
        for(let i = 0; i < 12; i++){
            if (count > 9) {
                count = 2;
            }
                ...
                <form method="post" action="../member01/member_dao.jsp" name="regForm">  <!-- 경로 수정 -->
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            <input type="text" class="form-control mb-2" name ="mem_RRN1" id="mem_RRN1" placeholder="주민번호 ( 6자리 -" maxlength="6" required>
                        </div>
                        <div class="col-md-5 mb-3">
                            <input type="text" class="form-control mb-2" name = "mem_RRN1" id="mem_RRN2" placeholder=" 7자리 )" maxlength="7" required>
                        </div>
                        <div class="col-md-3 mb-2">
                            <input class=" btn btn-secondary" type="button" value="사용자 인증"  onclick="checkRRN()"> <!-- 데이터 추가  -->
                        </div>
