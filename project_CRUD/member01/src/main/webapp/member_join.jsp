	...
	<div class="container row">
		...
		<div class="col-lg-7">
			<div class="jumbotron" style="padding-top: 20px;">
				...
				<!-- form -->
				<form method="post" action="/member01/mem_models/member_dao.jsp" name="actionType">
					<!-- 경로 수정 -->
					...
					<div class="row">
						...
						<div class="col-md-6 mb-2">
							<input type="button" class="btn btn-secondary" value="중복확인">
							<!-- 데이터 추가  -->
						</div>
					</div>
				...
				<form name="logout" method="post"
					action="/member01/mem_models/member_dao.jsp">
